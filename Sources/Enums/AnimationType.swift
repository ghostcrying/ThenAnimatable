...
public indirect enum AnimationType {
    ...
    case shake(repeatCount: Int = 1)
    case pop(repeatCount: Int = 1)
    case squash(repeatCount: Int = 1)
    case flip(along: Axis = .x)
    case morph(repeatCount: Int = 1)
    case flash(repeatCount: Int = 1)
    case wobble(repeatCount: Int = 1)
    case swing(repeatCount: Int = 1)
    case rotate(direction: RotationDirection, repeatCount: Int = 1)
    case moveTo(x: Double, y: Double)
    case moveBy(x: Double, y: Double)
    case scale(fromX: Double, fromY: Double, toX: Double, toY: Double)
    case spin(repeatCount: Int = 1)
    case compound(animations: [AnimationType], run: Run)
    case none
    
    public enum FadeWay: String, CaseIterable {
        case `in`, out, inOut = "inout", outIn = "outin"
    }
    public enum Way: String, CaseIterable {
        case out, `in`
    }
    ...
    public enum RotationDirection: String, CaseIterable {
        case cw, ccw
    }
    public enum Run: String, CaseIterable {
...
extension AnimationType: ThenStringEnum {
