...
final class ColorTypeTests: XCTestCase {
    ...
    func testHexStringToColor() {
        // without alpha
        XCTAssertEqual(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), UIColor(hex: "FFFFFF"))
        XCTAssertEqual(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), UIColor(hex: "000000"))
        XCTAssertEqual(#colorLiteral(red: 1, green: 0, blue: 0, alpha: 1), UIColor(hex: "FF0000"))
        XCTAssertEqual(#colorLiteral(red: 0, green: 1, blue: 0, alpha: 1), UIColor(hex: "00FF00"))
        XCTAssertEqual(#colorLiteral(red: 0, green: 0, blue: 1, alpha: 1), UIColor(hex: "0000FF"))
        XCTAssertEqual(#colorLiteral(red: 1, green: 0, blue: 1, alpha: 1), UIColor(hex: "FF00FF"))
        XCTAssertEqual(#colorLiteral(red: 0, green: 1, blue: 1, alpha: 1), UIColor(hex: "00FFFF"))
        XCTAssertEqual(#colorLiteral(red: 1, green: 1, blue: 0, alpha: 1), UIColor(hex: "FFFF00"))
        
        // with alpha
        XCTAssertEqual(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 0), UIColor(hex: "00FFFFFF"))
        XCTAssertEqual(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 0), UIColor(hex: "00000000"))
        XCTAssertEqual(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1), UIColor(hex: "FFFFFFFF"))
